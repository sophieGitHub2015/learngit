...
public class AhoCorasickDoubleArrayTrie<V>
{
	...
	public static void main(String[] args) {
        TreeMap<String, DicWordTerm> map = new TreeMap<String, DicWordTerm>();
        NatureFreqElem elem1 = new NatureFreqElem("LW",100);
        NatureFreqElem elem2 = new NatureFreqElem("MDW", 200);
        NatureFreqElem elem3 = new NatureFreqElem("MDW", 200);
        NatureFreqElem elem4 = new NatureFreqElem("MDW", 200);

        List<NatureFreqElem> puElem1 = new ArrayList<NatureFreqElem>();
        puElem1.add(elem1);
        puElem1.add(elem2);
        List<NatureFreqElem> puElem2 = new ArrayList<NatureFreqElem>();
        puElem2.add(elem3);
        List<NatureFreqElem> puElem3 = new ArrayList<NatureFreqElem>();
        puElem3.add(elem4);
        map.put("发展",new DicWordTerm("发展", puElem1));
        map.put("负责人",new DicWordTerm("负责人", puElem2));
        map.put("负责",new DicWordTerm("负责", puElem3));
